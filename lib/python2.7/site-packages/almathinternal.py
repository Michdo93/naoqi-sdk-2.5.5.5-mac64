...
def isConvex(pInputPoints):
    """isConvex(vectorPosition2D pInputPoints) -> bool"""
    return _almathinternal.isConvex(pInputPoints)

def getConvexHullGraham(pPoints, pEpsSinus=1e-4, pEpsDistance=1e-6):
    """
    ...
    """
    return _almathinternal.getConvexHullGraham(pPoints, pEpsSinus, pEpsDistance)

def getConvexHullGrahamInPlace(pResult, pEpsSinus=1e-4, pEpsDistance=1e-6):
    """
    ...
    """
    return _almathinternal.getConvexHullGrahamInPlace(pResult, pEpsSinus, pEpsDistance)
...
class VelocitySaturationProfile(_object):
    ...
    def __call__(self, pX):
        ...
        return _almathinternal.VelocitySaturationProfile___call__(self, pX)
...
_almathinternal.TRACKER_BANG_swigconstant(_almathinternal)
...
class AnticipationTracker(_object):
    ...
    def isFinished(self, pTime):
        ...
        return _almathinternal.AnticipationTracker_isFinished(self, pTime)
...
class OpenLoopFeedBack(_object):
    ...
    def isFinished(self, pTime):
        ...
        return _almathinternal.OpenLoopFeedBack_isFinished(self, pTime)
...
class ThetaOdometryFusion(_object):
    ...
    def __init__(self, covariantFactor, period):
        """__init__(AL::Math::ThetaOdometryFusion self, float covariantFactor, float period) -> ThetaOdometryFusion"""
        this = _almathinternal.new_ThetaOdometryFusion(covariantFactor, period)
        try:
            self.this.append(this)
        except:
            self.this = this

    def computeOdometryFusion(self, pThetaVelGyr, pThetaVelMre, pWheelFLSensor, pWheelFRSensor, pWheelBSensor):
        """computeOdometryFusion(ThetaOdometryFusion self, float pThetaVelGyr, float pThetaVelMre, float pWheelFLSensor, float pWheelFRSensor, float pWheelBSensor)"""
        return _almathinternal.ThetaOdometryFusion_computeOdometryFusion(self, pThetaVelGyr, pThetaVelMre, pWheelFLSensor, pWheelFRSensor, pWheelBSensor)
    ...
    def useGyroAndKalman(self, isEnabled):
        """useGyroAndKalman(ThetaOdometryFusion self, bool isEnabled)"""
        return _almathinternal.ThetaOdometryFusion_useGyroAndKalman(self, isEnabled)


    def setConfig(self, config):
        """setConfig(ThetaOdometryFusion self, AL::Math::ThetaOdometryFusion::Config const & config)"""
        return _almathinternal.ThetaOdometryFusion_setConfig(self, config)
...
class Key(_object):
    ...
    def deserialize(self, tree):
        ...
        return _almathinternal.Key_deserialize(self, tree)
...
def new_clone(pKey):
    ...
    return _almathinternal.new_clone(pKey)
...
def computeRightDerivativeOrder1AtKey(pIndex, pKey, pRightIndex, pRightNeighbor, pRes):
    """computeRightDerivativeOrder1AtKey(int pIndex, Key pKey, int pRightIndex, Key pRightNeighbor, vectorFloat pRes)"""
    return _almathinternal.computeRightDerivativeOrder1AtKey(pIndex, pKey, pRightIndex, pRightNeighbor, pRes)
...
class ALInterpolationBangBangAcceleration(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(AL::Math::Interpolation::ALInterpolationBangBangAcceleration self, float pPositionFinal, Limits pLimits, float pPeriod, AL::Math::Interpolation::ALInterpolationBangBangAcceleration::Policy pPolicy) -> ALInterpolationBangBangAcceleration
    ...
    def init(self, *args):
        """
        init(ALInterpolationBangBangAcceleration self, float pPositionInit, float pPositionFinal, float pVelocityInit, Limits pLimits, float pPeriod, AL::Math::Interpolation::ALInterpolationBangBangAcceleration::Policy pPolicy)
    ...
    def setInitStateOrder1(self, pPositionInit, VelocityInit):
        """setInitStateOrder1(ALInterpolationBangBangAcceleration self, float pPositionInit, float VelocityInit)"""
        return _almathinternal.ALInterpolationBangBangAcceleration_setInitStateOrder1(self, pPositionInit, VelocityInit)
...
def setDuration(pObject, pDuration):
    """setDuration(ALInterpolationBangBangAcceleration pObject, float pDuration)"""
    return _almathinternal.setDuration(pObject, pDuration)
class AnyInterpolator(_object):
    ...
    def setInitState(self, pInitState):
        """setInitState(AnyInterpolator self, vectorFloat pInitState)"""
        return _almathinternal.AnyInterpolator_setInitState(self, pInitState)


    def getCurrentInterpolation(self, pTime, pOrder, pOutput):
        """getCurrentInterpolation(AnyInterpolator self, float pTime, unsigned int pOrder, vectorFloat pOutput)"""
        return _almathinternal.AnyInterpolator_getCurrentInterpolation(self, pTime, pOrder, pOutput)
...
class BezierSequence(AnyInterpolator):
    ...
    def setInitState(self, pInitState):
        ...
        return _almathinternal.BezierSequence_setInitState(self, pInitState)
    ...
    def addMultipleKeys(self, pKeysAtTimes):
        """addMultipleKeys(BezierSequence self, AL::Math::Interpolation::TALJointCommandVector const & pKeysAtTimes)"""
        return _almathinternal.BezierSequence_addMultipleKeys(self, pKeysAtTimes)
    ...
    def addOffset(self, pOffset):
        """addOffset(BezierSequence self, float pOffset)"""
        return _almathinternal.BezierSequence_addOffset(self, pOffset)


    def addOffsetWithSaturation(self, pOffset, pMinValue, pMaxValue):
        """addOffsetWithSaturation(BezierSequence self, float pOffset, float pMinValue, float pMaxValue)"""
        return _almathinternal.BezierSequence_addOffsetWithSaturation(self, pOffset, pMinValue, pMaxValue)
...
class ALPath2D(_object):
    ...
    def positionAtLengthInPlace(self, pLength, pResultPosition):
        """positionAtLengthInPlace(ALPath2D self, float pLength, Position2D pResultPosition)"""
        return _almathinternal.ALPath2D_positionAtLengthInPlace(self, pLength, pResultPosition)


    def positionAtLength(self, pLength):
        """positionAtLength(ALPath2D self, float pLength) -> Position2D"""
        return _almathinternal.ALPath2D_positionAtLength(self, pLength)
    ...
    def windingAngleAtLength(self, pLength):
        """windingAngleAtLength(ALPath2D self, float pLength) -> float"""
        return _almathinternal.ALPath2D_windingAngleAtLength(self, pLength)


    def getAllDerivativesAtLength(self, pLength, pPositionResult, pTangentResult, pCurvatureResult, pCurvatureDerivativeResult):
        """getAllDerivativesAtLength(ALPath2D self, float pLength, Position2D pPositionResult, Position2D pTangentResult, float & pCurvatureResult, float & pCurvatureDerivativeResult)"""
        return _almathinternal.ALPath2D_getAllDerivativesAtLength(self, pLength, pPositionResult, pTangentResult, pCurvatureResult, pCurvatureDerivativeResult)
    ...
    def maxCurvatureInInterval(self, pLengthMin, pLengthMax):
        """maxCurvatureInInterval(ALPath2D self, float pLengthMin, float pLengthMax) -> float"""
        return _almathinternal.ALPath2D_maxCurvatureInInterval(self, pLengthMin, pLengthMax)


    def cloneEnd(self, pDistance):
        """cloneEnd(ALPath2D self, float pDistance) -> ALPath2D"""
        return _almathinternal.ALPath2D_cloneEnd(self, pDistance)


    def accept(self, pVisitor):
        """accept(ALPath2D self, ALPath2DVisitor pVisitor)"""
        return _almathinternal.ALPath2D_accept(self, pVisitor)
...
class ALDirectPath2D(ALPath2D):
    ...
    def cloneEnd(self, pDistance):
        ...
        return _almathinternal.ALDirectPath2D_cloneEnd(self, pDistance)
...
class ALPath2DFlat(ALDirectPath2D):
    ...
    def cloneEnd(self, pDistance):
        ...
        return _almathinternal.ALPath2DFlat_cloneEnd(self, pDistance)


    def init(self, pPointInit, pTangentInit, pCurvatureInit, pPointFinal, pTangentFinal, pCurvatureFinal):
        """init(ALPath2DFlat self, Position2D pPointInit, Position2D pTangentInit, float pCurvatureInit, Position2D pPointFinal, Position2D pTangentFinal, float pCurvatureFinal)"""
        return _almathinternal.ALPath2DFlat_init(self, pPointInit, pTangentInit, pCurvatureInit, pPointFinal, pTangentFinal, pCurvatureFinal)
    ...
    def positionAtLengthInPlace(self, pLength, pPositionResult):
        """positionAtLengthInPlace(ALPath2DFlat self, float pLength, Position2D pPositionResult)"""
        return _almathinternal.ALPath2DFlat_positionAtLengthInPlace(self, pLength, pPositionResult)


    def getAllDerivativesAtLength(self, pLength, pPositionResult, pTangentResult, pCurvatureResult, pCurvatureDerivativeResult):
        """getAllDerivativesAtLength(ALPath2DFlat self, float pLength, Position2D pPositionResult, Position2D pTangentResult, float & pCurvatureResult, float & pCurvatureDerivativeResult)"""
        return _almathinternal.ALPath2DFlat_getAllDerivativesAtLength(self, pLength, pPositionResult, pTangentResult, pCurvatureResult, pCurvatureDerivativeResult)
    ...
    def maxCurvatureInInterval(self, pLengthMin, pLengthMax):
        ...
        return _almathinternal.ALPath2DFlat_maxCurvatureInInterval(self, pLengthMin, pLengthMax)


    def windingAngleAtLength(self, pLength):
        """windingAngleAtLength(ALPath2DFlat self, float pLength) -> float"""
        return _almathinternal.ALPath2DFlat_windingAngleAtLength(self, pLength)


    def accept(self, pVisitor):
        """accept(ALPath2DFlat self, ALPath2DVisitor pVisitor)"""
        return _almathinternal.ALPath2DFlat_accept(self, pVisitor)
...
class ALPath2DComposed(ALPath2D):
    ...
    def append(self, pDirectPath):
        """append(ALPath2DComposed self, ALDirectPath2D pDirectPath)"""
        return _almathinternal.ALPath2DComposed_append(self, pDirectPath)
    ...
    def replace(self, i, pDirectPath):
        """replace(ALPath2DComposed self, size_t i, ALDirectPath2D pDirectPath)"""
        return _almathinternal.ALPath2DComposed_replace(self, i, pDirectPath)
    ...
    def windingAngleAtLength(self, pLength):
        ...
        return _almathinternal.ALPath2DComposed_windingAngleAtLength(self, pLength)


    def getAllDerivativesAtLength(self, pLength, pPositionResult, pTangentResult, pCurvatureResult, pCurvatureDerivativeResult):
        """getAllDerivativesAtLength(ALPath2DComposed self, float pLength, Position2D pPositionResult, Position2D pTangentResult, float & pCurvatureResult, float & pCurvatureDerivativeResult)"""
        return _almathinternal.ALPath2DComposed_getAllDerivativesAtLength(self, pLength, pPositionResult, pTangentResult, pCurvatureResult, pCurvatureDerivativeResult)


    def positionAtLengthInPlace(self, pLength, pResultPosition):
        """positionAtLengthInPlace(ALPath2DComposed self, float pLength, Position2D pResultPosition)"""
        return _almathinternal.ALPath2DComposed_positionAtLengthInPlace(self, pLength, pResultPosition)
    ...
    def maxCurvatureInInterval(self, pLengthMin, pLengthMax):
        ...
        return _almathinternal.ALPath2DComposed_maxCurvatureInInterval(self, pLengthMin, pLengthMax)
    ...
    def cloneEnd(self, pLength):
        """cloneEnd(ALPath2DComposed self, float pLength) -> ALPath2D"""
        return _almathinternal.ALPath2DComposed_cloneEnd(self, pLength)


    def accept(self, pVisitor):
        """accept(ALPath2DComposed self, ALPath2DVisitor pVisitor)"""
        return _almathinternal.ALPath2DComposed_accept(self, pVisitor)


    def approximateWithFlatPaths(self, pPointInit, pPointFinal, pTangentInit, pTangentFinal, pPoints, pTolerances, pUseTangentInit, pUseTangentFinal):
        """approximateWithFlatPaths(ALPath2DComposed self, Position2D pPointInit, Position2D pPointFinal, Position2D pTangentInit, Position2D pTangentFinal, vectorPosition2D pPoints, vectorFloat pTolerances, bool pUseTangentInit, bool pUseTangentFinal)"""
        return _almathinternal.ALPath2DComposed_approximateWithFlatPaths(self, pPointInit, pPointFinal, pTangentInit, pTangentFinal, pPoints, pTolerances, pUseTangentInit, pUseTangentFinal)
